...
/**
 * Interpreter to parse query text into executable query criteria
 */
public class SqlSyntaxInterpreter {

    /**
     * Parse query text into executable query criteria
     * @param text the query text to parse
     * @throws QuerySyntaxException if the query is improperly formed
     * @return the executable query criteria
     */
